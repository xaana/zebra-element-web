...
export default class Resizer<C extends IConfig, I extends ResizeItem<C> = ResizeItem<C>> {
    ...
    */
    ...
    protected createSizerAndDistributor(resizeHandle: HTMLDivElement): {
        sizer: Sizer;
    ...
    protected getResizeHandles(): HTMLElement[] {
