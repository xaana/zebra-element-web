...
export const useTextmenuCommands = (editor: Editor) => {
  ...
  const onEmojify = useCallback(() => console.log('onEmojify'), [])
  const onCompleteSentence = useCallback(
    () => console.log('onCompleteSentence'),
    []
  )
  const onFixSpelling = useCallback(() => console.log('onFixSpelling'), [])
  const onMakeLonger = useCallback(() => console.log('onMakeLonger'), [])
  const onMakeShorter = useCallback(() => console.log('onMakeShorter'), [])
  const onTldr = useCallback(() => console.log('onTldr'), [])
  const onTone = useCallback((tone: string) => console.log('onTone'), [])
