...
export const Sidebar = memo(
    ({ isOpen, children, side }: { isOpen?: boolean; children?: React.ReactNode; side: "left" | "right" }) => {
        const windowClassName = cn(
            "absolute top-0 bg-white lg:bg-white/30 lg:backdrop-blur-xl h-full z-[999] duration-300 transition-[width] border border-neutral-200 dark:border-neutral-800 w-80",
