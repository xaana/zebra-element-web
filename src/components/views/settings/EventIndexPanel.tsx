...
import { formatBytes, formatCountLong } from "matrix-react-sdk/src/utils/FormattingUtils";
...
import SeshatResetDialog from "matrix-react-sdk/src/components/views/dialogs/SeshatResetDialog";
...
export default class EventIndexPanel extends React.Component<{}, IState> {
    ...
    private onManage = async (): Promise<void> => {
        Modal.createDialogAsync(
            ...
            import("matrix-react-sdk/src/async-components/views/dialogs/eventindex/ManageEventIndexDialog"),
            {
                onFinished: () => {},
            },
            null,
