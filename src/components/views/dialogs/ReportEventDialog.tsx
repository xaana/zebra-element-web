...
import LabelledCheckbox from "matrix-react-sdk/src/components/views/elements/LabelledCheckbox";
...
export default class ReportEventDialog extends React.Component<IProps, IState> {
    ...
    public render(): React.ReactNode {
        ...
        const displayName = this.props.mxEvent.getSender()?.split(":")[0].substring(1);
        ...
        return (
            ...
            >
                <div className="mx_ReportEventDialog" id="mx_ReportEventDialog">
                    <p>This message is forwarded to Turium Zebra. This contact will not be notified.</p>
                    {adminMessage}
                    <Field
                        className="mx_ReportEventDialog_reason"
                        element="textarea"
                    ...
                    {progress}
                    {error}
                    {this.props.mxEvent.getSender()!=="@zebra:securezebra.com"&&ignoreUserCheckbox}
                </div>
                <DialogButtons
                    primaryButton={_t("action|send_report")}
                    onPrimaryButtonClick={this.onSubmit}
