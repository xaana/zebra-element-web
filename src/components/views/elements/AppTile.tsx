...
import { aboveLeftOf, ContextMenuButton } from "matrix-react-sdk/src/components/structures/ContextMenu";
import PersistedElement, { getPersistKey } from "matrix-react-sdk/src/components/views/elements/PersistedElement";
import { WidgetType } from "matrix-react-sdk/src/widgets/WidgetType";
import { ElementWidget, StopGapWidget } from "matrix-react-sdk/src/stores/widgets/StopGapWidget";
import { showContextMenu, WidgetContextMenu } from "matrix-react-sdk/src/components/views/context_menus/WidgetContextMenu";
...
import { IApp, isAppWidget } from "matrix-react-sdk/src/stores/WidgetStore";
...
import { parseUrl } from "matrix-react-sdk/src/utils/UrlUtils";
    ...
    private getTileTitle(): JSX.Element {
        ...
        return (
            <span>
                ...
                <b>{name==="Jitsi" ? "Zebra Meeting" : name}</b>
                <span>
                    {title ? titleSpacer : ""}
                    {title}
                </span>
