...
const ToggleResizeHandle: React.FC<IResizeHandleProps> = ({ vertical, reverse, collapse, id, passRef }) => {
    ...
    if (collapse) {
        classNames.push("mx_ResizeHandle--to-right");
    } else {
...
export default ToggleResizeHandle;
