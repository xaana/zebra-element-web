...
import * as ImageUtils from "matrix-react-sdk/src/ImageUtils";
...
import LinkWithTooltip from "matrix-react-sdk/src/components/views/elements/LinkWithTooltip";
            ...
            <div className="mx_LinkPreviewWidget">
                <div className="mx_LinkPreviewWidget_wrapImageCaption">
                    ...
                    <div className="mx_LinkPreviewWidget_caption">
                        ...
                        <div className="mx_LinkPreviewWidget_description text-primary">
