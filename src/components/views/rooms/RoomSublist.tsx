...
import { Enable, Resizable } from "matrix-react-sdk/node_modules/re-resizable/lib/index";
...
import RoomListStore, { LISTS_UPDATE_EVENT, LISTS_LOADING_EVENT } from "matrix-react-sdk/src/stores/room-list/RoomListStore";
...
export default class RoomSublist extends React.Component<IProps, IState> {
    ...
    public constructor(props: IProps) {
        ...
        if(props.tagId === DefaultTagID.Untagged) {
            const DM_ROOMS: Room[] = arrayFastClone(RoomListStore.instance.orderedLists[this.props.tagId] || []).concat(arrayFastClone(RoomListStore.instance.orderedLists[DefaultTagID.DM] || []));
            DM_ROOMS.sort((a,b)=>b.getLastActiveTimestamp()-a.getLastActiveTimestamp());
            this.state = {
                isResizing: false,
    ...
    // TODO order not update when send new meesgae in room
    ...
    private onListsUpdated = (): void => {
        ...
        if(this.props.tagId === DefaultTagID.Untagged){
            newRooms = arrayFastClone(RoomListStore.instance.orderedLists[this.props.tagId] || []).concat(arrayFastClone(RoomListStore.instance.orderedLists[DefaultTagID.DM] || []));
            newRooms.sort((a,b)=>b.getLastActiveTimestamp()-a.getLastActiveTimestamp());    
        }
        else{
