...
import { isValid3pidInvite } from "matrix-react-sdk/src/RoomInvite";
...
import { SpaceScopeHeader } from "matrix-react-sdk/src/components/views/rooms/SpaceScopeHeader";
...
export default class MemberList extends React.Component<IProps, IState> {
    ...
    public componentDidMount(): void {
        ...
        if(DMRoomMap.shared().getRoomIds().has(this.props.roomId)){
            const cli = MatrixClientPeg.safeGet();
            if (cli) {
                const room = cli.getRoom(this.props.roomId);
                if(room){
                    const functionalUsers = getFunctionalMembers(room);
    ...
    public render(): React.ReactNode {
        ...
        return (
            ...
            >
                {this.state.showInvite && inviteButton}
