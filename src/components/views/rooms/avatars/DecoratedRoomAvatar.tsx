...
import { isPresenceEnabled } from "matrix-react-sdk/src/utils/presence";
...
export default class DecoratedRoomAvatar extends React.PureComponent<IProps, IState> {
    ...
    private calculateIcon(): Icon {
        ...
        const members = this.props.room.currentState.getMembers();
        ...
        } else if (otherUserId&&this.props.room.getJoinedMemberCount() === 3&&joinedMembers.length === 2) {
