...
import MImageReplyBody from "matrix-react-sdk/src/components/views/messages/MImageReplyBody";
import { isVoiceMessage } from "matrix-react-sdk/src/utils/EventUtils";
...
import MVoiceMessageBody from "matrix-react-sdk/src/components/views/messages/MVoiceMessageBody";
import { ViewRoomPayload } from "matrix-react-sdk/src/dispatcher/payloads/ViewRoomPayload";
import { renderReplyTile } from "matrix-react-sdk/src/events/EventTileFactory";
    ...
    public render(): React.ReactNode {
        ...
        return (
            <div className={classes}>
                ...
                <a href={permalink} ref={this.anchorElement}>
                    {sender}
                    {renderReplyTile(
                        {
                            ...this.props,
