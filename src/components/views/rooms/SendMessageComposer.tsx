...
import { withMatrixClientHOC, MatrixClientProps } from "matrix-react-sdk/src/contexts/MatrixClientContext";
...
import {
    ...
    runSlashCommand,
    shouldSendAnyway,
} from "matrix-react-sdk/src/editor/commands";
    ...
    public render(): React.ReactNode {
        ...
        return (
            <div className="flex flex-row items-center">
                ...
                {this.props.showStop && (
                    <div
                        className="w-5 h-5 bg-foreground rounded-full flex items-center justify-center cursor-pointer"
                        onClick={this.props.stopBotStream}
                    >
                        <Square className="h-2 w-2 fill-background" stroke="background" />
                    </div>
                )}
            </div>
        );
