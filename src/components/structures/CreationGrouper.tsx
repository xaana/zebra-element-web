...
import MessagePanel, { WrappedEvent } from "matrix-react-sdk/src/components/structures/MessagePanel";
...
import GenericEventListSummary from "matrix-react-sdk/src/components/views/elements/GenericEventListSummary";
import { SeparatorKind } from "matrix-react-sdk/src/components/views/messages/TimelineSeparator";
...
export class CreationGrouper extends BaseGrouper {
    ...
    public getTiles(): ReactNode[] {
        ...
        for (const ejected of this.ejectedEvents) {
            if (ejected.event.event.type === "m.room.encryption") {
                continue;
            }
            ret.push(
