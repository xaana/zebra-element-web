...
export const MessageChildDatabaseResult: React.FC<TableProps<DataItem>> = ({
  ...
  return (
    <div className="zexa-w-full">
      <TableStyle>
        <div className="table__container zexa-rounded-md zexa-border zexa-border-solid scrollbar--custom">
          {data && data.length > 0 && (
            <>
              <Table>
                <TableHeader>
                        ...
                        >
                          {column ? (
                            ...
                            ![
                              ...
                              <span>
                                {parseFloat(column.toString()).toLocaleString(
                                  'en-AU'
                                )}
                              </span>
                            ) : (
              ...
              <div className="zexa-border-t zexa-w-full">
                <div className="zexa-flex zexa-items-center zexa-justify-between">
                  {totalEntries && (
                    <div className="zexa-font-normal zexa-text-muted-foreground zexa-text-xs zexa-px-0">
